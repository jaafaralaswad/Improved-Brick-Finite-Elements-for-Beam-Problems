...
from post_processing import compute_tip_displacement, plot_tip_displacement_z
...
length = 300.0   # Beam length (axial direction)
...
numel = 3              # Number of elements along the beam length
ne_L = 3               # Number of nodes per element in axial direction (minimum = 2)
...
if visualize_reference:
    img_fname = figures_dir / "reference_configuration-example-2.png"
...
if plot_displacement:
    ...
    plot_tip_displacement_z(tip_displacements, length, save_path=figures_dir / "tip_displacement_z-example-2.png")

# ================================
# VISUALIZE DEFORMED CONFIGURATION
# ================================
if visualize_final:
    img_fname_def = figures_dir / "final_configuration-example-2.png"
